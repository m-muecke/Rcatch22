...
Please open the included vignette within an R environment or visit the detailed [`catch22` gitbook](https://time-series-features.gitbook.io/catch22) for detailed information on all the features and implementations in various programming languages.
